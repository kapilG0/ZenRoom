...
function browserVersion(userAgent, vendor, opera) {
  ...
  const regex = regexList[browserString] || void 0;
  if (regex === void 0) {
    return null;
  }
...
function getMethod(target, prop) {
  ...
  const method = async function method2(storeName, ...args) {
...
var ShepherdPro = class extends Evented {
  constructor(...args) {
    super(...args);
    this.apiKey = void 0;
    this.apiPath = void 0;
